    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
        ...
        <div style={{
          ...
          {job.company?.logo
            ? <Image width={500} height={200} src={job.company.logo} alt={job.company.name}
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <h3 style={{
            fontSize: 15, fontWeight: 600, color: '#e2d9f3',
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
        <div style={{ ...shimmer, width: 44, height: 44, borderRadius: 10, flexShrink: 0 }} />
      ...
      <div style={{ display: 'flex', gap: 6 }}>
        {[80, 72, 88].map((w, i) => (
          <div key={i} style={{ ...shimmer, height: 24, width: w }} />
        ))}
      </div>
      ...
      <div style={{
        ...
        <div style={{ ...shimmer, height: 34, width: 88, borderRadius: 8 }} />
      </div>
    </div>
  );
}
  ...
  return (
    <span style={{
      ...
      <svg width="9" height="9" viewBox="0 0 24 24" fill="none"
        stroke="currentColor" strokeWidth="3" style={{ opacity: 0.7 }}>
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .chip-btn { background: none; cursor: pointer; }
        .chip-btn:hover { border-color: #a78bfa !important; color: #a78bfa !important; }
        .search-input-el { flex:1; background:transparent; border:none; outline:none; font-size:15px; color:#e5e7eb; }
      ...
      <div style={{ minHeight: '100vh', background: '#080612', fontFamily: "'DM Sans','Helvetica Neue',sans-serif" }}>
        ...
        <section style={{ padding: '80px 24px 48px', textAlign: 'center' }}>
          ...
          <div style={{
            display: 'inline-flex', alignItems: 'center', gap: 7, marginTop: 25,
          ...
          <h1 style={{
            ...
            color: '#e2d9f3', letterSpacing: '-0.03em',
            margin: '0 0 10px', lineHeight: 1.1,
          }}>
            Find your next{' '}
            <span style={{ color: '#a78bfa' }}>opportunity</span>
          </h1>
          ...
          <div style={{ maxWidth: 680, margin: '0 auto' }}>
            <div style={{
              ...
              borderRadius: 14, padding: '6px 6px 6px 18px', gap: 10,
        ...
        <div style={{ maxWidth: 1000, margin: '0 auto', padding: '0 24px 64px' }}>
          ...
          {!loading && searched && jobs.length === 0 && !error && (
            <div style={{ textAlign: 'center', padding: '64px 24px' }}>
              ...
              <p style={{ fontSize: 17, fontWeight: 600, color: '#e2d9f3', margin: '0 0 6px' }}>
                No jobs found
              </p>
          ...
          {!searched && !loading && (
            <div style={{ textAlign: 'center', padding: '64px 24px' }}>
              ...
              <p style={{ fontSize: 14, color: '#6b7280', margin: 0 }}>
                Type a role, skill, location, or experience level above
              </p>
            </div>
          )}
